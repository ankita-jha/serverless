...
<html>
    ...
    <body>  
      ...
      <p><a href=https://ankitajha.me/v1/verifyUser?token=${token}&email=${email} >
        https://ankitajha.me/v1/verifyUser?token=${token}&email=${email} </a> </p>
        </body></html>
    </body>
</html>`;
